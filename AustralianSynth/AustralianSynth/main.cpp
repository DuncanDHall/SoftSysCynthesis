...
{
	double dOutput = sin(dFrequencyOutput * 2.0 * 3.14159 * dTime); //+ sin((dFrequencyOutput + 200) * 2.0 * 3.14159 * dTime);
	return dOutput * 0.5; // Master Volume

	//double dOutput2 = sin(dFrequencyOutput * 2.0 * 3.14159 * dTime);
	/*
	if (dOutput > 0) {
		return 0.3;
	}
